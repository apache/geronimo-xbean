 ...
 */
public class GBeanDependencyManager implements DependencyManager {
    /**
    ...
    public GBeanDependencyManager(LifecycleMonitor lifecycleMonitor) throws Exception {
    ...
    private class DependencyManagerLifecycleListener extends LifecycleAdapter {
        public void unloaded(ObjectName objectName) {
            synchronized (GBeanDependencyManager.this) {
