...
public class GBeanRegistry {
     ...
     * @throws org.apache.geronimo.kernel.GBeanAlreadyExistsException if there is already a GBean registered with the instance's name
     */
     ...
     * @throws org.apache.geronimo.kernel.GBeanNotFoundException if there is no GBean registered with the supplied name
     */
