...
import org.gbean.beans.GBeanInstanceUtil;
 ...
 */
public class GBeanKernel implements Kernel {
    /**
     ...
     * The gbean registry
     */
    private final GBeanRegistry registry;
     ...
     */
    private GBeanLifecycleMonitor lifecycleMonitor;
     ...
     */
    public GBeanKernel(String kernelName) {
        ...
        this.registry = new GBeanRegistry();
    }
    ...
    public GBeanInfo getGBeanInfo(ObjectName name) throws GBeanNotFoundException {
        ...
        return GBeanInstanceUtil.createGBeanInfo(gbeanInstance.getGeronimoBeanDefinition());
    }

    public GBeanData getGBeanData(ObjectName name) throws GBeanNotFoundException, InternalKernelException {
        GBeanInstance gbeanInstance = registry.getGBeanInstance(createGBeanName(name));
        return GBeanInstanceUtil.createGBeanData(gbeanInstance.getGeronimoBeanDefinition());
    }
    ...
    public void loadGBean(GBeanData gbeanData, ClassLoader classLoader) throws GBeanAlreadyExistsException, InternalKernelException {
        ...
        GBeanInstance gbeanInstance = new GBeanInstance(GBeanInstanceUtil.createGeronimoBeanDefinition(gbeanData, classLoader),
                this,
                dependencyManager,
    ...
    public void boot() throws Exception {
        ...
        bootTime = new Date();
        log = LogFactory.getLog(GBeanKernel.class.getName());
        ...
        lifecycleMonitor = new GBeanLifecycleMonitor(this);
        publicLifecycleMonitor = new LifecycleMonitorFlyweight(lifecycleMonitor);
        dependencyManager = new GBeanDependencyManager(publicLifecycleMonitor);
        proxyManager = new GBeanProxyManager(this);
