 ...
 */
public class GBeanLifecycleMonitor implements LifecycleMonitor {
    private static final Log log = LogFactory.getLog(org.gbean.kernel.GBeanLifecycleMonitor.class);
    ...
    public GBeanLifecycleMonitor(Kernel kernel) {
        this.kernel = kernel;
    ...
    private class RawLifecycleBroadcaster implements LifecycleBroadcaster {
        ...
        public void fireLoadedEvent() {
            ...
            GBeanLifecycleMonitor.this.fireLoadedEvent(objectName);
        }

        public void fireStartingEvent() {
            GBeanLifecycleMonitor.this.fireStartingEvent(objectName);
        }

        public void fireRunningEvent() {
            GBeanLifecycleMonitor.this.fireRunningEvent(objectName);
        }

        public void fireStoppingEvent() {
            GBeanLifecycleMonitor.this.fireStoppingEvent(objectName);
        }

        public void fireStoppedEvent() {
            GBeanLifecycleMonitor.this.fireStoppedEvent(objectName);
        }

        public void fireFailedEvent() {
            GBeanLifecycleMonitor.this.fireFailedEvent(objectName);
        }

        public void fireUnloadedEvent() {
            GBeanLifecycleMonitor.this.fireUnloadedEvent(objectName);
