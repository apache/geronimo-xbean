 ...
 */
public class GBeanContextReference implements FactoryBean, Serializable {
    public static BeanDefinitionHolder createBeanDefinition() {
        RootBeanDefinition beanDefinition = new RootBeanDefinition(GBeanContextReference.class, 0);
        return new BeanDefinitionHolder(beanDefinition, GBeanContext.class.getName());
    }

    public final Class getObjectType() {
        return GBeanContext.class;
    }
