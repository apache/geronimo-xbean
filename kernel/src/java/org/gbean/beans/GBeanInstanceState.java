 ...
 * @version $Rev$ $Date$
 */
public final class GBeanInstanceState {
    ...
    void attemptFullStart() {
        ...
        try {
            ...
            // oops there was a problem, stop the gbean
            setStateInstance(State.STOPPING);
            lifecycleBroadcaster.fireStoppingEvent();
...
//            if (t instanceof Exception) {
                log.error("Error while starting; GBean is now in the STOPPED state: objectName=\"" + objectName + "\"", t);
                return;
...
//            }
    ...
    void attemptFullStop() {
        ...
        try {
            if (!gbeanInstance.destroyInstance()) {
...
//            if (t instanceof Exception) {
                log.error("Error while stopping; GBean is now in the STOPPED state: objectName=\"" + objectName + "\"", t);
//            } else if (t instanceof Error) {
//                throw (Error) t;
//            } else {
//                throw new Error(t);
