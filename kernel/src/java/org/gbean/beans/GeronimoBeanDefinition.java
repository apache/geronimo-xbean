...
public final class GeronimoBeanDefinition extends RootBeanDefinition {
    private ObjectName objectName;
    private boolean enabled = true;
    private MutablePropertyValues dynamicPropertyValue = new MutablePropertyValues();

//    public GeronimoBeanDefinition() {
//    }

    public GeronimoBeanDefinition(GeronimoBeanDefinition original) {
        super(original);
    ...
    public GeronimoBeanDefinition(ObjectName objectName,
            Class beanClass,
            boolean enabled,
