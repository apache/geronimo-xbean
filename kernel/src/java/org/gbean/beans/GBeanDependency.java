...
public class GBeanDependency {
    ...
    /**
     * Is the GBeanInstance waitng for me to start?
     */
    ...
    public GBeanDependency(GBeanInstance gbeanInstance, String name, Set patterns, Kernel kernel, DependencyManager dependencyManager) {
    ...
    public synchronized boolean start() {
        ...
        if (proxyTarget == null) {
            ...
            proxyTarget = (ObjectName) gbeans.iterator().next();
    ...
    private synchronized void checkStatus() {
        ...
        // todo fix me
        if (gbeanInstance.getState() == State.RUNNING_INDEX && gbeans.size() != 1) {
            gbeanInstance.stop();
        } else if (waiting && gbeans.size() == 1) {
    ...
    private String getDescription() {
        return "depependency=" + name + ", gbeanInstance " + gbeanInstance.getObjectName();
    }
