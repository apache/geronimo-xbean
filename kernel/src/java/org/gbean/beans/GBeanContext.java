 ...
 * current state.
 *
 * @version $Rev: 151106 $ $Date: 2005-02-02 18:49:54 -0800 (Wed, 02 Feb 2005) $
 */
public interface GBeanContext {
    public static final ThreadLocal threadLocal = new ThreadLocal() {
        public void set(Object value) {
            if (value != null && !(value instanceof GBeanContext)) {
                throw new IllegalArgumentException("Value is not an instance of GeronimoBeanContext");
            }
            super.set(value);
        }
    };
