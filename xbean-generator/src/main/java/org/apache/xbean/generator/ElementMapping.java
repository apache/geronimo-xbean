...
public class ElementMapping implements Comparable {
    ...
    private final Set<AttributeMapping> attributes;
    private final Map<String, AttributeMapping> attributesByName;
    private final List<List<ParameterMapping>> constructors;
    private final List<String> flatProperties;
    private final Map<String, MapMapping> maps;
    private final Map<String, String> flatCollections;
    ...
    public ElementMapping(String namespace, String elementName, String className, String description, 
            ...
            String contentProperty, Set<AttributeMapping> attributes, List<List<ParameterMapping>> constructors, List<String> flatProperties,
            Map<String, MapMapping> maps, Map<String, String> flatCollections, List<String> superClasses, Set<String> interfaces) {
        ...
        Map<String, AttributeMapping> attributesByName = new HashMap<String, AttributeMapping>();
    ...
    public Set<AttributeMapping> getAttributes() {
        return attributes;
    }
    ...
    public Map<String, MapMapping> getMapMappings() {
        return maps;
    }
    ...
    public Map<String, String> getFlatCollections() {
        return flatCollections;
    }

    public List<String> getFlatProperties() {
        return flatProperties;
    }

    public List<List<ParameterMapping>> getConstructors() {
        return constructors;
    }
