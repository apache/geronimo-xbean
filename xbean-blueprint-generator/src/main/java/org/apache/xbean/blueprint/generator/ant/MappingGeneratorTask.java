 ...
 */
package org.apache.xbean.blueprint.generator.ant;

import org.apache.tools.ant.BuildException;
import org.apache.tools.ant.taskdefs.MatchingTask;
import org.apache.tools.ant.types.Path;
import org.apache.xbean.blueprint.generator.BlueprintXmlMetadataGenerator;
import org.apache.xbean.blueprint.generator.BlueprintXsdGenerator;
...
public class MappingGeneratorTask extends MatchingTask implements LogFacade {
    ...
    public void execute() throws BuildException {
        ...
        try {
            ...
            ArtifactSet artifactSet = new HashedArtifactSet();
            GeneratorPlugin[] plugins = new GeneratorPlugin[]{
                new BlueprintXmlMetadataGenerator(destFile, artifactSet, this),
                new DocumentationGenerator(destFile, artifactSet, this),
                new BlueprintXsdGenerator(destFile, artifactSet, this),
                new WikiDocumentationGenerator(destFile, artifactSet, this)
            };
            ...
            for (Iterator iterator = namespaces.iterator(); iterator.hasNext();) {
                ...
                for (int i = 0; i < plugins.length; i++) {
                    ...
                    plugin.generate(namespaceMapping, Collections.<String, String>emptyMap());
                }
            }
