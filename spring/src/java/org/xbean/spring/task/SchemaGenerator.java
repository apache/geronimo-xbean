...
public class SchemaGenerator {
    ...
    protected void generateSchema(PrintWriter out, String namespace, List elements) {
        ...
        out.println("           targetNamespace='" + namespace + "'");
        out.println("           xmlns:xs='http://www.w3.org/2001/XMLSchema'");
        out.println("           xmlns:tns='" + namespace + "'>");
    ...
    protected void generateSchemaElementComplexProperty(PrintWriter out, SchemaElement element, JProperty property) {
        ...
        if (property.getType().isArrayType()) {
            for (Iterator iter = allElements.iterator(); iter.hasNext();) {
                SchemaElement elem = (SchemaElement) iter.next();
                if (elem.getNamespace().equals(element.getNamespace()) &&
                    elem.getType().getQualifiedName().equals(property.getType().getArrayComponentType().getQualifiedName())) {
                    out.println("        <xs:complexType><xs:sequence minOccurs='0' maxOccurs='unbounded'><xs:element ref='tns:" + elem.getLocalName() + "'/></xs:sequence></xs:complexType>");
                    found = true;
                    break;
                }
            }
