 ...
 */
package org.apache.xbean.spring.generator.ant;
...
import org.apache.xbean.spring.generator.*;
    ...
    public void execute() throws BuildException {
        ...
        try {
            ...
            GeneratorPlugin[] plugins = new GeneratorPlugin[]{
                new SpringXmlMetadataGenerator(destFile, artifactSet, this),
                new DocumentationGenerator(destFile, artifactSet, this),
                new SpringXsdGenerator(strictXsdOrder, destFile, artifactSet, this),
            ...
            for (Iterator iterator = namespaces.iterator(); iterator.hasNext();) {
                ...
                for (int i = 0; i < plugins.length; i++) {
                    ...
                    plugin.generate(namespaceMapping, Collections.emptyMap());
                }
            }
